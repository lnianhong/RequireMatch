...
dlmwrite('receiver0228_10W.csv',[data_receive(1:indexR,1),dataR],'precision',16);
dlmwrite('transimitter_10W.csv',[data_tran(1:indexT,1),dataT],'precision',16);
